...
public:
    Main() {}
        ...
        ContextMain = new CPU::Context(); //Composição, criação de ptr para objt contexto
        ping_name = "ping"; //pq não declarou?
        pong_name = "pong";

        ping = new CPU::Context(func_ping, (char *) ping_name.data()); //Composição, criação de ptr para objt contexto
        pong = new CPU::Context(func_pong, (char *) pong_name.data()); //Composição, criação de ptr para objt contexto
